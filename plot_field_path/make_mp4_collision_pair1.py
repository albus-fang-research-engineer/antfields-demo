...
BASE_PATH  = 'baseline_collision_pair1'        # <-- bottom-row data
MESH_PATH  = 'gibson/mesh.obj'
CEILING_Z  = 0.02
FLOOR_Z    = -0.12

# Movie config
FRAMES_DIR = 'movie_frames_baseline_collision'
MOVIE_OUT  = 'baseline_collision_epochs_movie.mp4'
FPS        = 10
...
# Title-card text
TITLE_MAIN = '2cm Collision Baseline'
